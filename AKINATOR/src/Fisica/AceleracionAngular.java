 ...
 * @author isaaczapatto
 */
public class AceleracionAngular extends javax.swing.JFrame {

    /**
     * Creates new form Aceleracion
     */
    public AceleracionAngular() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AceleracionAngular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AceleracionAngular().setVisible(true);
            }
        });
    }
