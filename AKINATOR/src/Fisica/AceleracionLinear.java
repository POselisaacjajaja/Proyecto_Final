 ...
 * @author isaaczapatto
 */
public class AceleracionLinear extends javax.swing.JFrame {

    /**
     * Creates new form Aceleracion
     */
    public AceleracionLinear() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AceleracionLinear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AceleracionLinear().setVisible(true);
            }
        });
    }
